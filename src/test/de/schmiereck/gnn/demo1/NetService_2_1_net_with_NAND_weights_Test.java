...
public class NetService_2_1_net_with_NAND_weights_Test {

    @Test
    public void test_calc_real_2_1_net_LL_with_NAND_weights() {
        // Arrange
        final Net net = arrange_real_2_1_net_with_NAND_weights(LOW_VALUE, LOW_VALUE);
    ...
    @Test
    public void test_calc_real_2_1_net_HL_with_NAND_weights() {
        // Arrange
        final Net net = arrange_real_2_1_net_with_NAND_weights(HIGH_VALUE, LOW_VALUE);
    ...
    @Test
    public void test_calc_real_2_1_net_HH_with_NAND_weights() {
        // Arrange
        final Net net = arrange_real_2_1_net_with_NAND_weights(HIGH_VALUE, HIGH_VALUE);

        // Act
        NetService.calc(net, LinearNeuronService::calc);

        // Assert
        assert_real_2_1_net(net, HIGH_VALUE, HIGH_VALUE, LOW_VALUE);
    }

    private Net arrange_real_2_1_net_with_NAND_weights(final int input0Value, final int input1Value) {
