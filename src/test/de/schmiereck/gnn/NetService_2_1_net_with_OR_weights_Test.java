...
public class NetService_2_1_net_with_OR_weights_Test {
    ...
    public void test_calc_real_2_1_net_LL_with_OR_weights() {
        ...
        // Assert
        assert_real_2x1_net(net, LOW_VALUE, LOW_VALUE, NULL_VALUE);
    }

    @Test
    public void test_calc_real_2x1_net_HL_with_OR_weights() {
        // Arrange
        ...
        // Assert
        assert_real_2x1_net(net, HIGH_VALUE, LOW_VALUE, HIGH_D2_VALUE);
    }

    @Test
    public void test_calc_real_2x1_net_HH_with_OR_weights() {
        // Arrange
