...
public class FuncNeuronService_calc_OR_func_Test {

    @Test
    public void test_calc_H_H_input_OR_func() {
        // Arrange
    ...
    @Test
    public void test_calc_H_L_input_OR_func() {
        // Arrange
        final Neuron in1Neuron = new Neuron();
        final Neuron in2Neuron = new Neuron();
        final Neuron neuron = new Neuron();
    ...
    @Test
    public void test_calc_L_L_input_OR_func() {
        // Arrange
        final Neuron in1Neuron = new Neuron();
        final Neuron in2Neuron = new Neuron();
        final Neuron neuron = new Neuron();
    ...
    public void test_calc_OR_func() {
        ...
        final int[] expectedValues = { -10,  -7,  -5, -2,  0,  2,  5,  7,  10,  7, 10,  7,  5,  2,  0, -2,  -5,  -7, -10 };
