...
public class FuncNeuronService_calc_XOR_func_Test {

    @Test
    public void test_calc_H_H_input_XOR_func() {
        // Arrange
        ...
        neuron.setFunc(Neuron.Func.XOR);
    ...
    @Test
    public void test_calc_H_L_input_XOR_func() {
        // Arrange
        final Neuron in1Neuron = new Neuron();
        final Neuron in2Neuron = new Neuron();
        final Neuron neuron = new Neuron();
    ...
    @Test
    public void test_calc_L_L_input_XOR_func() {
        // Arrange
        final Neuron in1Neuron = new Neuron();
        final Neuron in2Neuron = new Neuron();
        final Neuron neuron = new Neuron();
    ...
    @Test
    public void test_calc_XOR_func() {
        // Arrange
        final Neuron in1Neuron = new Neuron();
        final Neuron in2Neuron = new Neuron();
        final Neuron neuron = new Neuron();
