...
public class FuncNeuronService_calc_AND_func_Test {
    ...
    @Test
    public void test_calc_L_L_input_AND_func() {
        // Arrange
        final Neuron in1Neuron = new Neuron();
        final Neuron in2Neuron = new Neuron();
        final Neuron neuron = new Neuron();
    ...
    @Test
    public void test_calc_AND_func() {
        // Arrange
        final Neuron in1Neuron = new Neuron();
        final Neuron in2Neuron = new Neuron();
        final Neuron neuron = new Neuron();
        ...
        final int[] expectedValues = { -10, -10, -10, -7, -5, -2,  0,  2,   5,  7,  5,  2,  0, -2, -5, -7, -10, -10, -10 };
